...
def test_default_configuration():
    ...
    assert config.history_file == Path(
        './test_history/test_history.csv').resolve()
...
def test_file_properties():
    ...
    config = CalculatorConfig(base_dir=Path('/custom_base_dir'))
    assert config.history_file == Path(
        '/custom_base_dir/history/calculator_history.csv').resolve()
    assert config.log_file == Path(
        '/custom_base_dir/logs/calculator.log').resolve()
...
def test_get_project_root():
    ...
    # Adjust the path check as needed based on your file structure
...
def test_log_file_property():
    ...
    config = CalculatorConfig(base_dir=Path('/new_base_dir'))
    assert config.log_file == Path(
        '/new_base_dir/logs/calculator.log').resolve()
...
def test_history_file_property():
    ...
    config = CalculatorConfig(base_dir=Path('/new_base_dir'))
    assert config.history_file == Path(
        '/new_base_dir/history/calculator_history.csv').resolve()
